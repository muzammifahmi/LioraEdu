  ...
  <body class="bg-gray-50">
      ...
      <div class="container mx-auto px-4">
        <nav class="flex items-center justify-between h-16 md:h-20">
          ...
          <div class="hidden md:flex items-center space-x-4">
            <a
              href="login.php"
              class="px-4 py-2 text-primary border border-primary hover:bg-primary hover:text-white transition duration-300 !rounded-button whitespace-nowrap"
              >Masuk</a
            >
            <a
              href="register.php"
              class="px-4 py-2 bg-primary text-white hover:bg-primary/90 transition duration-300 !rounded-button whitespace-nowrap"
              >Daftar</a
            >
          </div>
      ...
      <div class="container mx-auto px-4 w-full">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div class="text-white">
            ...
            <a
              href="#"
              class="inline-block px-6 py-3 bg-white text-primary font-semibold hover:bg-gray-100 transition duration-300 !rounded-button whitespace-nowrap"
              >Mulai Belajar</a
            >
          </div>
            ...
            <div class="flex-none w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
              ...
              >
                <div class="h-48 overflow-hidden">
                  <img
                    src="https://readdy.ai/api/search-image?query=professional%2520web%2520development%2520workspace%2520with%2520modern%2520computer%2520setup%252C%2520showing%2520code%2520on%2520screen%252C%2520clean%2520desk%2520with%2520minimal%2520design%252C%2520soft%2520lighting%252C%2520professional%2520environment&width=400&height=250&seq=2&orientation=landscape"
                ...
                <div class="p-4">
                  ...
                  <div class="flex items-center mb-2">
                    ...
                    <span class="text-gray-600 text-sm ml-2">4.5 (128)</span>
                  </div>
                  <div class="flex items-center text-gray-600 text-sm mb-3">
                    <i class="ri-user-line mr-1"></i>
                    <span>1,245 siswa</span>
                  </div>
                  <div class="flex items-center justify-between">
                    <span class="text-primary font-bold">Rp 599.000</span>
    ...
    <section class="cta-section py-16 text-white">
      <div class="container mx-auto px-4 text-center">
        ...
        <a
          href="#"
          class="inline-block px-8 py-4 bg-white text-primary font-semibold hover:bg-gray-100 transition duration-300 !rounded-button whitespace-nowrap text-lg"
          >Daftar Sekarang</a
        >
      </div>
    </section>
            ...
            <ul class="space-y-4">
              <li class="flex items-start">
                ...
                <span class="text-gray-400"
                  >Jl. Sudirman No. 123, Jakarta Pusat, DKI Jakarta 10220</span
                >
              </li>
        ...
        <div class="border-t border-gray-800 pt-8">
          <div class="flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex space-x-6">
              <a
                href="#"
                class="text-gray-500 text-sm hover:text-white transition duration-300"
                >Syarat & Ketentuan</a
              >
              <a
                href="#"
