...
(1, 'Apa arti dari kata “merahasiakan”?', 'Menyebarkan', 'Menyimpan rahasia', 'Menghapus', 'Menuliskan', 'b'),
(1, 'Kalimat efektif adalah kalimat yang...', 'bertele-tele', 'mudah dipahami', 'panjang dan rumit', 'menggunakan kata baku', 'b'),
(1, 'Kata baku dari “praktek” adalah...', 'praktekan', 'praktik', 'praktek', 'praktikan', 'b'),
(1, 'Manakah kalimat yang menggunakan ejaan yang benar?', 'Saya tidak tahu menau.', 'Saya tidak tau-menau.', 'Saya tidak tahu-menahu.', 'Saya tidak tau-menahu.', 'c');

-- Soal untuk Kuis 2 (id_kuis = 2)
INSERT INTO soal (id_kuis, pertanyaan, pilihan_a, pilihan_b, pilihan_c, pilihan_d, jawaban_benar) VALUES
(2, 'Sinonim dari kata “indah” adalah...', 'jelek', 'menarik', 'buruk', 'rata', 'b'),
(2, 'Antonim dari kata “rajin” adalah...', 'giat', 'malas', 'cepat', 'teliti', 'b'),
(2, 'Sinonim dari kata “besar” adalah...', 'luas', 'tinggi', 'agung', 'kecil', 'c'),
(2, 'Antonim dari kata “dingin” adalah...', 'beku', 'hangat', 'dingin sekali', 'sejuk', 'b');
